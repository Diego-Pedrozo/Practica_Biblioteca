...
class PublicacionModel(models.Model):
    ...
    titulo = models.TextField(verbose_name=_('Título'), help_text=_(''), null=False, unique=False)
    descripcion = models.TextField(verbose_name=_('Descripción'), help_text=_(''), null=False, unique=False)
